...
fig_data <- panel_data |>
  ...
  rename(
    ...
    "Miles to nearest facility" = miles_to_nearest_facility
)
...
tbl_summ_stats <- fig_data |>
  ...
  mutate(across(where(is.numeric), ~ formatC(., format = "fg", digits = 2))) |>
...
![Scatter Plot of Doctor Visits by Unemployment Rate](./midterm-images/scatterplot-visits-vs-enemployment-rate.png){#fig-scatterplot-visits-vs-unemployment-rate width="100%"}
