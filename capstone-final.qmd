...
ice_median <- round(median(panel_data$average_daily_population, na.rm = TRUE), 1)
...
@tbl-model-summary provides a summary of the results from our three regression models. The presence of an ICE detention facility in a ZCTA code (Model 1) is associated with a statistically significant decrease in the percentage of adults reporting a doctor visit within the past year, controlling for confounders and fixed effects. The distance to the nearest ICE detention facility (Model 2) also shows a statistically significant negative association with doctor visits, suggesting that closer proximity to enforcement activity is associated with reduced health care utilization. The regional chilling effect model (Model 3) indicates that being within 50 miles of an ICE detention facility is associated with a statistically significant decrease in doctor visits, further supporting the notion that enforcement activity has spillover effects on health care utilization in nearby areas.
